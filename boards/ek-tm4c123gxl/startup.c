...
__attribute__((weak)) void PWMGen1Handler() {};
__attribute__((weak)) void batmon_adc0_handler() {};
__attribute__((weak)) void Serial_0_ISR() {};
__attribute__((weak)) void Serial_1_ISR() {};
__attribute__((weak)) void Serial_2_ISR() {};
__attribute__((weak)) void Serial_3_ISR() {};
__attribute__((weak)) void Serial_4_ISR() {};
__attribute__((weak)) void Serial_5_ISR() {};
__attribute__((weak)) void Serial_6_ISR() {};
__attribute__((weak)) void Serial_7_ISR() {};
__attribute__((weak)) void I2CIntHandler() {};
